...
- フォーク専用ファイル: `CLAUDE.md`, `devlog/`, `contexts/`, `user_testing.ipynb`
...
# → CLAUDE.md, devlog/, contexts/, user_testing.ipynb 以外が表示されたら異常
```
...
git add CLAUDE.md devlog/ contexts/ user_testing.ipynb
